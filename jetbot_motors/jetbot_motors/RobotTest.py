...
robot.forward(1, 1.0)   # Move forward at speed 150 for 1 second.
robot.left(1, 0.5)      # Spin left at speed 200 for 0.5 seconds.
robot.forward(1, 1.0)   # Repeat the same movement 3 times below...
robot.left(1, 0.5)
robot.forward(1, 1.0)
robot.left(1, 0.5)
robot.forward(1, 1.0)
...
robot.right(1)  # No time is specified so the robot will start spinning forever.
